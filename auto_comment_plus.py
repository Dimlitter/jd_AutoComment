    ...
    for item in items:
        ...
        if "赠品" in pname or "非实物" in pname or "增值服务" in pname:
            result = ["赠品挺好的。",
                      ...
                      "赠品正合我意。",
                      "赠品很好，挺不错的。"
                      "本来买了产品以后还有些担心。但是看到增品以后就放心了。",
                      "不论品值且何，至少说明店家的对客态度很好！",
                      "我很喜欢这些商品！",
                      "我对于商品的跗加值很在乎，恰好这些贈品为这件商品提供了这样的的附加值，这令我很满意",
                      "我希望其他店家也能像这家店学习，提供一些贈品以及附加服务",
                      "说实话，我这次购物纯粹是冲看贈品耒的（笑）",
                      "白嫖香香！",
                      "感觉现在的网购环境环境越来越好了，以前网购的时候还没有过么多贴心的贈品和增值服务",
                      "如果没有赠品的话，我可能就不会买这个东西了",
                      "一种商品当它的售价差不多的时候，它的销量就会的十相近。过个时候要得到更多的销量就需要增值服务，来提高它的价值，以此增加其市场竞争力。",
                      "对于发达国家耒说更是如此。但是当电商顶替了买体店的位置的时候，传统的服务业就不得不转型，过样的话，增值服务，或者赠品变得十分重要了。"，
                      "第一次用京东，被这种赠品和增值服物的良好态度感动到了",
                      "赠品还行",
                      "贈品可以单独买吗？（笑）",
                      "Q：贈品怎之样一？A：啊对对对！（笑死，赠品怎么可能有评论）"
                      ]
        else:
